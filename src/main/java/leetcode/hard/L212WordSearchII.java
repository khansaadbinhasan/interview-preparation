...
//["abcb"]
//[["o","a","a","n"],["e","t","a","e"],["i","h","k","r"],["i","f","l","v"]]
//["oath","pea","eat","rain","eta","oaaneaiflk"]
//[["a"]]
//["a"]
//[["a"]]
//["b"]
...
public class L212WordSearchII {
    ...
    public List<String> findWords(char[][] board, String[] words) {
        ...
        for( String word: words ){
            if( exists(board, word) ) answers.add(word);
        }
    ...
    public boolean isExist(char[][] board, String word, int i, int j, int k){
        ...
        if( isExist(board, word, i+1, j, k+1) || isExist(board, word, i-1, j, k+1) ||
                isExist(board, word, i, j+1, k+1) || isExist(board, word, i, j-1, k+1) ) return true;
