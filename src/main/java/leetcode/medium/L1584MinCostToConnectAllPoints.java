...
//[[3,12],[-2,5],[-4,1]]
//[[1,1]]
//[[1,1],[1,2],[3,4],[0,-100],[100,100],[98,65],[65,-9999]]
//[[0,0],[1,1],[2,2]]
public class L1584MinCostToConnectAllPoints {
...
//
//        Map<Point, PriorityQueue<Integer>> pointMap = getPointMap(points);
//
...
//    }
//
//    public Map<Point, PriorityQueue<Integer>> getPointMap(int[][] points){
//        Map<Point, PriorityQueue<Integer>> pointMap = new HashMap<>();
//
...
//                    pq = pointMap.get(p1);
//
//                    pq.offer(calcManhattanDistance(p1, p2));
//
//                    pointMap.put(p1, pq);
//                }
//            }
...
//    }
//
//    public int calcManhattanDistance(Point p1, Point p2){
...
//            this.node1 = node1;
//            this.node2 = node2;
//            this.weight = Math.abs(node1[0]-node2[0]) + Math.abs(node1[1]-node2[1]);
//        }
//
//        @Override
//        public int compareTo(Edge e){
//            return Integer.compare(this.weight, e.weight);//ascending order
//        }
//
//    }
//
...
//            Edge e = pq.poll();
//
//            String node1 = Arrays.toString(e.node1);
//            String node2 = Arrays.toString(e.node2);
//
//            if( visitedSet.contains(node1) && visitedSet.contains(node2) ){
//                continue;
//            }
//
...
//        for( int i = 0; i < N; i++ ){
//            for( int j = i+1; j < N; j++ ){
//                List<Integer> weightNode = new LinkedList<>();
//                weightNode.add(manhattanDist(points, i, j));
//                weightNode.add(j);
//                adj.get(i).add(weightNode);
//
//                weightNode = new LinkedList<>();
//                weightNode.add(manhattanDist(points, i, j));
//                weightNode.add(i);
//                adj.get(j).add(weightNode);
//            }
//        }
//
//        int res = 0;
...
//                List<Integer> lst = adj.get(i).get(j);
//                if( !visit.contains(lst.get(1)) ){
//                    minHeap.add(new int[]{lst.get(0),lst.get(1)});
//                }
//            }
//        }
//
...
//    }
//
//    public int manhattanDist(int[][] points, int a, int b){
//        return Math.abs(points[a][0]-points[b][0]) + Math.abs(points[a][1]-points[b][1]);
//    }

    Map<Point, List<Point>> map = new HashMap<>();
    List<Point> lstPoints = new LinkedList<>();
    Point start;
    ...
    public int minCostConnectPoints(int[][] points) {
        ...
        while(!q.isEmpty()){
            ...
            for( Point p: map.get(point) ){
                p.dist = Math.min(p.dist, manhattan(point, p));
                if( !set.contains(p) ) {
                    q.add(p);
                    set.add(p);
                }
...
//            if( lstPoints.get(i).dist != Integer.MAX_VALUE ) cost += lstPoints.get(i).dist;
//        }
    ...
    //[[1,0],[1,2],[1,3]]
    //{1->[0,2,3],0->[1],2->[1],3->[1]}
    public void createMap(int[][] points){
        for( int i = 0; i < points.length; i++ ){
            start = new Point(points[i][0], points[i][1]);
            lstPoints.add(start);
        }

        int n = lstPoints.size();

        for( int i = n-1; i >= 0; i-- ){
            Point p = lstPoints.get(i);
            lstPoints.remove(p);
            map.put(p, new LinkedList<>(lstPoints));
            lstPoints.add(p);
        }
    }
...
//    public void createMap(int[][] points){
//        for( int i = 0; i < points.length; i++ ){
//            lstPoints.add(new Point(points[i][0], points[i][1]));
//        }
//
//        start = lstPoints.get(0);
//
//        int n = lstPoints.size();
//
//        for( int i = n-1; i >= 0; i-- ){
//            Point p = lstPoints.get(i);
//            lstPoints.remove(p);
//            List<Point> pointList = new LinkedList<>(lstPoints);
//            for( int j = 0; j < pointList.size(); j++ ){
//                pointList.get(j).dist = manhattan(p, pointList.get(j));
//            }
//            map.put(p, pointList);
//            lstPoints.add(p);
//        }
    ...
    public int minCostConnectPoints2(int[][] points) {
        ...
        while(visit.size() < N){
            ...
            for( int[] nei: adj.get(i) ){
                if( !visit.contains(nei[1]) ) pq.add(nei);
            }
        }
