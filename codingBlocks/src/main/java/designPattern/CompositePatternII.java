...
public class CompositePatternII {
    ...
    public static class Playlist implements IComponent {
        ...
        public void add(IComponent component){
            System.out.println("Adding song to playlist " + this.playlistName + ": " + component.getName());
            this.playlist.add(component);
        }

        public void remove(IComponent component){
            System.out.println("Removing song from playlist: " + this.playlistName + ": " + component.getName());
            this.playlist.remove(component);
        }
    }

    public static class Song implements IComponent {
        ...
        public void setPlaybackSpeed(float speed) {
            this.speed = speed;
            System.out.println("Playback speed has been set to: " + this.speed);
        }
